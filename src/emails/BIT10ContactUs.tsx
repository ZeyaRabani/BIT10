...
export function BIT10ContactUs({ email, name, message }: { email: string, name: string, message: string }) {
    return (
        <Html>
            <Head />
                ...
                <Body className='bg-[#f3f3f5] font-sansSerif'>
                    <Container className='w-[680px] max-w-full mx-auto'>
                        ...
                        <Section className='flex flex-col space-y-4 p-4 bg-white rounded-b-md'>
                            ...
                            <Text className='text-[17px] leading-[17px] text-[#3c3f44]'>
                                This email was sent from the BIT10 Contact Us page. You can reply to this email to send a response to the recipient.</Text>
                        </Section>
                    </Container>
