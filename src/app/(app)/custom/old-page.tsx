                    ...
                    <SelectGroup>
                        ...
                        <SelectItem value='btc'>
                            <div className='inline-flex items-center justify-center'>
                                <Image src='/assets/swap/ckbtc.png' alt='ckBTC' width={25} height={25} className='z-20 rounded-full' />
                                <div className='ml-2'>ckBTC</div>
                            </div>
                        </SelectItem>
                        <SelectItem value='eth'>
                            <div className='inline-flex items-center justify-center'>
                                <Image src='/assets/swap/cheth.png' alt='ckETH' width={25} height={25} className='z-20 rounded-full' />
                                <div className='ml-2'>ckETH</div>
                            </div>
                        </SelectItem>
                        <SelectItem value='usdc'>
                            <div className='inline-flex items-center justify-center'>
                                <Image src='/assets/swap/ckusdc.webp' alt='ckUSDC' width={25} height={25} className='z-20 rounded-full' />
                                <div className='ml-2'>ckUSDC</div>
                            </div>
                        </SelectItem>
                    </SelectGroup>
                </SelectContent>
