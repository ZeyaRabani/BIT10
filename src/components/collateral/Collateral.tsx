                ...
                <CardContent>
                    ...
                    <div className='grid md:grid-cols-3 gap-4 items-center'>
                        ...
                        <div className='flex w-full flex-col space-y-3 col-span-2'>
                            ...
                            <p className='text-xl'>Total Collateral: 78 USD</p>
                            {/* <p className='text-lg'>Token Supply (100% Collateral Coverage): 41.77825388 USD</p> */}
                            <p className='text-lg'>Token Supply (150% Collateral Coverage): 27 BIT10.DEFI</p>
                            <table className='w-full table-auto'>
                                <thead>
                                    <tr className='hover:bg-accent p-1 rounded'>
                                        ...
                                        {/* <th className='text-left'>Token Supply (100% Collateral Coverage)</th>
                                        <th className='text-left'>Token Supply (150% Collateral Coverage)</th> */}
                                    </tr>
                                </thead>
                                <tbody>
                                    {bit10Allocation.map(({ name, address, totalCollateral, fill, walletAddress }) => (
