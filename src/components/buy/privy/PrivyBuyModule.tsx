...
export const paymentTokenPrivy = [
...
export const bit10TokenbuyPrivy = [
...
export const fetchPrivyTokenBalance = async (address: string, user: any, connection: any): Promise<string> => {
    try {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const buyPrivyBIT10Token = async (tickInName: string, tickOutName: string, tickOutAmount: number, program: any, tokenMint: any, user: any) => {
    try {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore
        // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
