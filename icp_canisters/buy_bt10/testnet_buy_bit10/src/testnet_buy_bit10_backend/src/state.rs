use crate::ecdsa::keys::EcdsaPublicKey;
...
pub const PRICE_FEED_CANISTER: Principal =
    Principal::from_slice(b"\x00\x00\x00\x00\x01\xc0\xdd\x96\x01\x01");
    ...
    fn default() -> Self {
        Self {
            ...
            custom_rpc: Some(CustomRpcConfig {
                ...
                api_key: Some("t-zdbfhdbfhbgnfjngjkmb".to_string()),
            }),
        }
    }
}
...
#[derive(CandidType, Deserialize, Debug, Default, PartialEq, Eq, Clone, Serialize)]
