...
use super::{EcdsaKeyName, BaseNetwork, InitArg};
...
#[derive(Debug, PartialEq, Eq, Clone, candid::CandidType, serde::Serialize, serde::Deserialize)]
pub struct CustomRpcConfig {
    pub url: String,
    pub api_key: Option<String>,
}

#[derive(Debug, PartialEq, Eq, candid::CandidType, serde::Serialize, serde::Deserialize)]
pub struct State {
...
impl Default for State {
    fn default() -> Self {
        Self {
            base_network: BaseNetwork::default(),
            ecdsa_key_name: EcdsaKeyName::default(),
            ecdsa_public_key: None,
            custom_rpc: Some(CustomRpcConfig {
                url: "https://base-sepolia.gateway.tatum.io/".to_string(),
                api_key: Some("hjdbhjbfjknkflbml;g,".to_string()),
            }),
        }
    }
}
...
impl From<InitArg> for State {
    fn from(init_arg: InitArg) -> Self {
        ...
        state.base_network = init_arg.base_network.unwrap_or_default();
