...
import { buyPayTokensBase, buyReceiveTokensBase, fetchBaseBIT10Balance, buyBaseBIT10Token } from './base/BaseBuyModule'
...
export default function BuyModule() {
    ...
    const payingTokenPrice = useMemo(() => {
        ...
        return 0;
    }, [chain, payingTokenAddress, icpAmount, btcAmount, ethAmount]);
    ...
    const buyDisabledConditions = !chain || buying || fromAmount >= balance || fromAmount >= balance * 1.01 || fromAmount <= 0 || Number(form.watch('receive_amount')) <= 0;
