...
const termsContent: TermSectionProps[] = [
    ...
    },
    {
        ...
        content: [
            'You acknowledge and agree that the smart contracts used in connection with the Website have not undergone any independent security audit. These smart contracts may contain errors, vulnerabilities, or other defects that could result in partial or total loss of funds. By using the Website, you expressly assume all risks associated with interacting with such unaudited smart contracts.',
            ...
            <div className='py-4 w-full'>
                ...
                <div className='w-full flex flex-col items-start justify-center space-y-4 px-2 md:px-[5vw]'>
                    ...
                    <div className='gap-1'>
                        ...
                        <p className='text-lg'>If you have any questions or concerns about these Terms of Service, please contact us at <a href='mailto:zeyarabani@bit10.app' className='text-primary underline cursor-pointer'>zeyarabani@bit10.app</a>.</p>
