            ...
            <div className='py-4 w-full'>
                ...
                <div className='w-full flex flex-col items-start justify-center space-y-4 px-2 md:px-[5vw]'>
                    ...
                    <div className='gap-1'>
                        ...
                        <p className='text-lg'>If you have any questions or concerns about this Privacy Policy, please contact us at <a href='mailto:zeyarabani@bit10.app' className='text-primary underline cursor-pointer'>zeyarabani@bit10.app</a>.</p>
