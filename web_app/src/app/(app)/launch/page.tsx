...
export default function Page() {
    return (
        <div className='animate-fade-bottom-up flex items-center justify-center w-full min-h-[60vh]'>
            <Card className='border-muted w-[300px] md:w-96 animate-fade-bottom-up p-6 flex flex-col space-y-6'>
                <Link href='/buy'>
                    <div className='rounded-md border-muted border hover:border-primary hover:text-primary'>
